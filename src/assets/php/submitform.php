<?php 
  $to = 'lisawells999@gmail.com' ;  // Replace email address with your own
  ...
  $sent = mail($to, $subject, $message) ; 
    if($sent) {
      ...
      echo "<h3>Sorry, your message wasn't sent.</h3><p>We seem to have encountered a problem sending your message. Please go back and try again.</p>"; 
}
